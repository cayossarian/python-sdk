...
_UNIT_TABLE = {
    ...
    "varh": (Unit.VOLT_AMPERE_REACTIVE_HOUR, 1.0),
    "kvarh": (Unit.VOLT_AMPERE_REACTIVE_HOUR, 1000.0),
    "VA": (Unit.VOLT_AMPERE, 1.0),
    "kVA": (Unit.VOLT_AMPERE, 1000.0),
    "VAh": (Unit.VOLT_AMPERE_HOUR, 1.0),
    "kVAh": (Unit.VOLT_AMPERE_HOUR, 1000.0),
    "%": (Unit.PERCENT, 1.0),
    "s": (Unit.SECONDS, 1.0),
