"""Observable application-state model for eBus proxies and adapters.

`Property` is a thread-safe, observable value with change callbacks;
...
than driving `homie.Device` directly.
"""
